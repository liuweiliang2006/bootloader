...
//	返回值：	无。
///////////////////////////////////////////////////////////////////////////////
static void SubBytes(unsigned char *pState, unsigned char nCount, uint8_t bInvert)
{
	unsigned char i;
...
//	返回值：	无。
///////////////////////////////////////////////////////////////////////////////
static void ShiftRows(unsigned char *pState, uint8_t bInvert)
{
	// 注意：状态数据以列形式存放！
...
//	返回值：	无。
///////////////////////////////////////////////////////////////////////////////
static void MixColumns(unsigned char *pState, uint8_t bInvert)
{
	unsigned char i;
	unsigned char temp;
